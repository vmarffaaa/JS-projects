const task= (i) => document.write(`<br>---------Task${i}---------`)
...
simpsons.forEach(person => {
    ...
    photo.alt = `${person.name} ${person.surname}`;
    document.write('----------------------------------------------------')
...
for (const course of coursesArray) {
    ...
    courseDiv.classList.add('_course');

    let titleDiv = document.createElement('h2');
    titleDiv.innerText = `Title: ${course.title}`;

    let monthDurationDiv = document.createElement('h3');
    monthDurationDiv.innerText = `Month Duration: ${course.monthDuration}`;

    let hourDurationDiv = document.createElement('h3');
    hourDurationDiv.innerText = `Hour Duration: ${course.hourDuration}`;
